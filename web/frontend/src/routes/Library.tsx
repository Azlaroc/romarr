...
import { Gamepad2, Search, ExternalLink, Trash2, Wand2, Archive, Fingerprint, FolderSearch } from 'lucide-react'
        ...
        actions={
          <>
            ...
            <Link
              to="/library/scan"
              className="inline-flex items-center gap-1.5 rounded-lg border border-purple-600/30 bg-purple-600/15 px-3 py-2 text-sm font-medium text-purple-400 hover:bg-purple-600/25"
              data-testid="library-scan-link"
            >
              Scan <FolderSearch className="h-3.5 w-3.5" />
            </Link>
            {config?.romm_url && (
